...
import { TOKENS, QUIKPAY_CONTRACT_ADDRESS, ARBITRUM_SEPOLIA } from "@/lib/contract"
...
export default function MerchantPage() {
  ...
  const publicClient = useMemo(() => {
    return createPublicClient({
      ...
      transport: http(ARBITRUM_SEPOLIA.rpcUrls.default.http[0])
    })
  }, [])
              ...
              <Card>
                <CardHeader>
                  ...
                  <div className="flex items-center gap-2 mt-2">
                    ...
                    <a className="text-xs text-muted-foreground" href={ARBITRUM_SEPOLIA.blockExplorers.default.url} target="_blank" rel="noreferrer">Explorer</a>
                  </div>
                      ...
                      <div key={tx.id} className="border rounded-lg p-4 hover:bg-muted/50 transition-colors">
                        <div className="flex justify-between items-start mb-3">
                          ...
                          <div className="text-right">
                            ...
                            <a href={`${ARBITRUM_SEPOLIA.blockExplorers.default.url}/tx/${tx.txHash}`} target="_blank" rel="noreferrer" className="text-xs text-blue-600 hover:underline">View Tx</a>
                          </div>
                        </div>
